...
namespace BookAuthors.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        // The code below is a boilerplate code to update the model from viewmodels and
        // vice-versa. Note that you can do these mappings with automapper or any other
        // way you prefer, as the code below is just an example to make this controller work
